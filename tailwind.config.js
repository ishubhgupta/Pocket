  ...
  theme: {
    extend: {
      colors: {
        ...
        // Secondary - Emerald (Success & Action)
        secondary: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      boxShadow: {
        ...
        'card': '0 4px 16px rgba(0, 0, 0, 0.08), 0 2px 4px rgba(0, 0, 0, 0.06)',
      ...
      backgroundImage: {
        ...
        'glass-dark': 'linear-gradient(135deg, rgba(30, 41, 59, 0.7), rgba(15, 23, 42, 0.3))',
      },
      backdropBlur: {
        'xs': '2px',
        'glass': '12px',
